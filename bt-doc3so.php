...
<body>
<form method="get">
    <input type="text" name="isNumber" placeholder="Nhap so can doc">
    <input type="submit">
</form>
<?php
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    $isWord = $_GET['isNumber'];
    $hundreds = floor($isWord / 100);
    $tens = floor($isWord / 10) % 10;
    $units = $isWord % 10;
    $isWord = $hundreds * 100 + $tens * 10 + $units;
    $readNumber = '';
    if ($isWord > 0 && $isWord < 1000) {
